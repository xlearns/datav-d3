...
!(function (t, n) {
  ...
  Vn.prototype = Wn.prototype = {
    ...
    property: function (t, n) {
      return arguments.length > 1
        ? this.each((null == n ? _n : "function" == typeof n ? mn : bn)(t, n))
        : this.node()[t];
    },
    ...
    text: function (t) {
      return arguments.length
        ? this.each(null == t ? kn : ("function" == typeof t ? Pn : Cn)(t))
        : this.node().textContent;
    },
    html: function (t) {
      return arguments.length
        ? this.each(null == t ? zn : ("function" == typeof t ? Dn : $n)(t))
        : this.node().innerHTML;
    },
    raise: function () {
      return this.each(Rn);
  ...
  function rr(t) {
    ...
    return (
      r === i && i === o
        ? (n = e = a)
        : ((n = ar((0.4360747 * r + 0.3850649 * i + 0.1430804 * o) / Qe)),
          (e = ar((0.0139322 * r + 0.0971045 * i + 0.7141733 * o) / Je))),
        ...
        ? this.styleTween(
            ...
            (function (t, n, e) {
              ...
              return function () {
                ...
                return (
                  null == u &&
                    (this.style.removeProperty(t), (c = u = vn(this, t))),
                  a === c
                    ? null
                    : a === r && c === i
                    ? o
  ...
  (Wn.prototype.interrupt = function (t) {
    ...
    (Wn.prototype.transition = function (t) {
      ...
      t instanceof ho
        ? ((n = t._id), (t = t._name))
        : ((n = go()), ((e = Io).time = Mi()), (t = null == t ? null : t + ""));
    ...
    function h(e) {
      ...
      function I(t) {
        ...
        switch (((C = n[0] - e[0]), (P = n[1] - e[1]), m)) {
          case Go:
          case Xo:
            x && ((C = Ko(S - i, Qo(N - l, C))), (a = i + C), (h = l + C)),
              w && ((P = Ko(E - u, Qo(k - d, P))), (c = u + P), (p = d + P));
            break;
          case Vo:
            $[1]
              ? (x &&
                ...
                w &&
                  ...
                  (w = 1)))
              : (x < 0
                  ? ((C = Ko(S - i, Qo(N - i, C))), (a = i + C), (h = l))
                  : x > 0 &&
                    ((C = Ko(S - l, Qo(N - l, C))), (a = i), (h = l + C)),
                w < 0
                  ? ((P = Ko(E - u, Qo(k - u, P))), (c = u + P), (p = d))
                  : w > 0 &&
                    ((P = Ko(E - d, Qo(k - d, P))), (c = u), (p = d + P)));
            break;
          case Wo:
            x && ((a = Ko(S, Qo(N, i - C * x))), (h = Ko(S, Qo(N, l + C * x)))),
              w &&
                ((c = Ko(E, Qo(k, u - P * w))), (p = Ko(E, Qo(k, d + P * w))));
        }
        h < a &&
          ((x *= -1),
          (r = i),
      ...
      if (null === this._x1) this._append`M${(this._x1 = t)},${(this._y1 = n)}`;
        ...
        if (Math.abs(s * u - c * f) > ka && i) {
          let h = e - o,
            ...
            b = _ / v,
            m = _ / y;
          Math.abs(b - 1) > ka && this._append`L${t + b * f},${n + b * s}`,
      ...
      null === this._x1
        ...
        e &&
          ...
          l > Ca
            ...
            : l > ka &&
              this._append`A${e},${e},0,${+(l >= Ea)},${s},${(this._x1 =
    ...
    function f() {
      ...
      if (
        ...
        if (t) {
          ...
          c.quadraticCurveTo(0, 0, v * va(_), v * _a(_)), c.arc(0, 0, v, _, b);
      if ((c.quadraticCurveTo(0, 0, p * va(g), p * _a(g)), c.closePath(), f))
    ...
    function o(e, i) {
      ...
      return (
        (function (e, r, i) {
          ...
          for (; ++o < t - 1; )
            (c = f), (f = tu(e[o + 1], r)), Ka[c | (f << 1)].forEach(p);
          Ka[f << 0].forEach(p);
          for (; ++u < n - 1; ) {
            for (
              o = -1,
    ...
    function u(e, r, i) {
      e.forEach(function (e) {
        var o = e[0],
          ...
          c = 0 | a,
          f = nu(r[c * t + u]);
        o > 0 && o < t && u === o && (e[0] = eu(o, nu(r[c * t + u - 1]), f, i)),
          a > 0 &&
            a < n &&
            c === a &&
  ...
  function pu(t, n, e, r, i, o) {
    ...
    return Math.abs(c) >= 33306690738754716e-32 * f
      ...
      : -(function (t, n, e, r, i, o, a) {
          ...
          if (
            ((C =
              11093356479670487e-47 * a + 33306690738754706e-32 * Math.abs(k)),
            (k += A * s + N * u - (E * f + S * c)),
            k >= C || -k >= C)
          )
            return k;
    ...
    update() {
      ...
      for (let o, a, u = 0; u < this._ids.length; u++) {
        ...
        for (
          ;
          (g = e[y]),
            pu(f, s, t[2 * y], t[2 * y + 1], t[2 * g], t[2 * g + 1]) >= 0;
        ...
        for (
          ;
          (g = e[_]),
            pu(f, s, t[2 * _], t[2 * _ + 1], t[2 * g], t[2 * g + 1]) < 0;
        ...
        if (y === l)
          for (
            ;
            (g = n[y]),
              pu(f, s, t[2 * g], t[2 * g + 1], t[2 * y], t[2 * y + 1]) < 0;
    ...
    _step(t, n, e) {
      ...
      do {
        ...
        if (((h = a[h]), -1 === h)) {
          if (
            ((h = i[(o[t] + 1) % i.length]),
            h !== r && Cu(n - c[2 * h], 2) + Cu(e - c[2 * h + 1], 2) < s)
          )
            return h;
          break;
        }
  ...
  (Tc.copy = function () {
    var t,
      n,
      e = new wc(this._x, this._y, this._x0, this._y0, this._x1, this._y1),
      r = this._root;
    if (!r) return e;
    ...
    (Tc.visitAfter = function (t) {
      ...
      for (
        this._root &&
        e.push(new _c(this._root, this._x0, this._y0, this._x1, this._y1));
        (n = e.pop());
  ...
  var Yc = {
    ...
    s: function (t, n) {
      ...
      return o === a
        ...
        : "0." + new Array(1 - o).join("0") + Rc(t, Math.max(0, n + o - 1))[0];
    },
  ...
  function Zc(t, n) {
    return Math.max(
      0,
      3 * Math.max(-8, Math.min(8, Math.floor(Fc(n) / 3))) - Fc(Math.abs(t))
    );
  }
  function Kc(t, n) {
    return (
      (t = Math.abs(t)), (n = Math.abs(n) - t), Math.max(0, Fc(n) - Fc(t)) + 1
    );
  }
  (t.format = void 0),
      ...
      var o,
        ...
        h = {
          ...
          polygonEnd: function () {
            ...
            var t = al(o, r);
            a.length
              ? (l || (i.polygonStart(), (l = !0)), rl(a, fl, t, e, i))
              : t &&
      ...
      function (t) {
        ...
        return {
          ...
          point: function (l, h) {
            ...
            if (
              (!n && (f = c = g) && t.lineStart(),
              g !== c && (!(d = a(n, p)) || nl(n, d) || nl(p, d)) && (p[2] = 1),
              g !== c)
            )
              (s = 0),
                g
          ...
          function e(r, i, o, a, u, c, f, s, l, h, d, p, g, y) {
            ...
            if (b > 4 * n && g--) {
              var m = a + h,
                ...
                T = xf((w /= M)),
                A =
                  uf(uf(w) - 1) < Qc || uf(o - l) < Qc ? (o + l) / 2 : ff(x, m),
                S = t(A, T),
                E = S[0],
                N = S[1],
                k = E - r,
  ...
  function ed(t) {
    ...
    function k() {
      ...
      return (
        (e = Gs(y, v, _)), (u = Hs(n, r)), (c = Hs(e, u)), (a = Qh(u, S)), C()
      );
    }
    function C() {
      return (f = s = null), E;
  ...
  function jd(t, n) {
    for (
      ...
      (e = t[i]), r && Gd(r, e) ? ++i : ((r = Wd((a = Hd(a, e)))), (i = 0));
    return r;
  }
  function Hd(t, n) {
    var e, r;
  ...
  function ep(t, n) {
    ...
    t: for (c = 3; c < o; ++c) {
      ...
      for (
        i.previous = e, i.next = r, e.next = r.previous = r = i, a = tp(e);
        (i = i.next) !== r;
      ...
      if ((a = t._squarify) && a.ratio === n)
        for (var a, u, c, f, s, l = -1, h = a.length, d = t.value; ++l < h; ) {
          ...
          u.dice
            ...
            : wp(u, e, r, d ? (e += ((i - e) * u.value) / d) : i, o),
            (d -= u.value);
        }
  ...
  function og(t, n, e) {
    var r = t[0],
      ...
      a = n[1];
    return (
      i < r ? ((r = ig(i, r)), (o = e(a, o))) : ((r = ig(r, i)), (o = e(o, a))),
      function (t) {
        return o(r(t));
      }
    );
    ...
    return (
      ...
      (e.tickFormat = (n, r) => {
        if (
          ...
          null == r && (r = 10 === a ? "s" : ","),
          "function" != typeof r &&
            (a % 1 || null != (r = Ic(r)).precision || (r.trim = !0),
            (r = t.format(r))),
          n === 1 / 0)
        )
          return r;
  ...
  function Sg(t) {
    var n = t(rg, rg),
      e = 1;
    function r() {
      return 1 === e ? t(rg, rg) : 0.5 === e ? t(Tg, Ag) : t(Mg(e), Mg(1 / e));
    }
    return (
  ...
  function zg(t, n, e, r) {
    ...
    return (
      ...
      e &&
        ((i.count = (n, r) => (
          Cg.setTime(+n), Pg.setTime(+r), t(Cg), t(Pg), Math.floor(e(Cg, Pg))
        )),
        (i.every = (t) => (
          (t = Math.floor(t)),
          isFinite(t) && t > 0
  ...
  const Dg = $g.range,
    ...
    Vg = zg(
      (t) => {
        t.setTime(
          t - t.getMilliseconds() - t.getSeconds() * Rg - t.getMinutes() * Fg
        );
      },
      (t, n) => {
        t.setTime(+t + n * qg);
    ...
    Qg = zg(
      ...
      (t, n) =>
        (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * Fg) / Ug,
      (t) => t.getDate() - 1
    ),
    Jg = Qg.range,
    ty = zg(
  ...
  function iy(t) {
    return zg(
      ...
      (t, n) =>
        (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * Fg) / Ig
    );
  }
  const oy = iy(0),
    ay = iy(1),
  ...
  function i_(t, n) {
    return (
      (t = r_(t)), ev(Ty.count(Oy(t), t) + (4 === Oy(t).getUTCDay()), n, 2)
    );
  }
  function o_(t) {
    return t.getUTCDay();
  ...
  function Nm(t, n, e) {
    ...
    return (
      ...
      (f.x1 = function (t) {
        return arguments.length
          ? ((r = null == t ? null : "function" == typeof t ? t : Jb(+t)), f)
          : r;
      }),
      (f.y = function (t) {
        return arguments.length
      ...
      (f.y1 = function (t) {
        return arguments.length
          ? ((e = null == t ? null : "function" == typeof t ? t : Jb(+t)), f)
          : e;
      }),
      (f.lineX0 = f.lineY0 =
        function () {
  ...
  (fw.prototype = uw.prototype),
        ...
        if ((u || (u = f = c()), h < l && ((s = h), (h = l), (l = s)), h > um))
          if (g > sm - um)
            u.moveTo(h * em(d), h * om(d)),
              u.arc(0, 0, h, d, p, !y),
              l > um &&
                (u.moveTo(l * em(p), l * om(p)), u.arc(0, 0, l, p, d, y));
          else {
            var v,
              _,
              b = d,
        ...
        if (i)
          if ("true" === i) i = !0;
            ...
            if (
              ...
              continue;
            ic && r[4] && !r[7] && (i = i.replace(/-/g, "/").replace(/T/, " ")),
              (i = new Date(i));
          } else i = e;
        else i = null;
        t[n] = i;
      ...
      function h() {
        if (r) {
          ...
          for (a = 0, i = new Array(f); a < s; ++a)
            ((c = t[a]).index = a),
              "object" != typeof c.source && (c.source = Cc(l, c.source)),
              "object" != typeof c.target && (c.target = Cc(l, c.target)),
    ...
    (t.geoBounds = function (t) {
      var n, e, r, i, o, a, u;
      if (
        ((Uf = qf = -(Rf = Ff = 1 / 0)), (jf = []), kf(t, ws), (e = jf.length))
      ) {
        ...
        for (a = -1 / 0, n = 0, r = o[(e = o.length - 1)]; n <= e; r = i, ++n)
          (i = o[n]),
            (u = Cs(r[1], i[0])) > a && ((a = u), (Rf = i[0]), (qf = r[1]));
      }
      return (
        (jf = Hf = null),
        Rf === 1 / 0 || Ff === 1 / 0
    ...
    (t.geoCircle = function () {
      ...
      return (
        (a.center = function (t) {
          return arguments.length
            ? ((e = "function" == typeof t ? t : js([+t[0], +t[1]])), a)
            : e;
        }),
        (a.radius = function (t) {
          return arguments.length
    ...
    (t.geoPath = function (t, n) {
      ...
      return (
        ...
        (a.projection = function (n) {
          return arguments.length
            ? ((e = null == n ? ((t = null), Yl) : (t = n).stream), a)
            : t;
        }),
        (a.context = function (t) {
          return arguments.length
            ? ((r = null == t ? ((n = null), new Yh(i)) : new Eh((n = t))),
    ...
    (t.pack = function () {
      ...
      function i(i) {
        ...
        return (
          ...
          (i.y = e / 2),
          t
            ? i.eachBefore(ip(t)).eachAfter(op(r, 0.5, o)).eachBefore(ap(1))
            : i
                .eachBefore(ip(rp))
                .eachAfter(op(Od, 1, o))
    ...
    (t.scaleLog = function t() {
      ...
      return (
        (n.copy = () => ug(n, t()).base(n.base())), Wp.apply(n, arguments), n
      );
    }),
    (t.scaleOrdinal = Qp),
      ...
      function r(r) {
        ...
        if (null != t) {
          const n = h.map((n, e) =>
            ...
            i = new Set(n).add("");
          for (const t of e)
            i.has(t) || (i.add(t), n.push(t), e.push(pp(t)), h.push(lp));
          (d = (t, e) => n[e]), (p = (t, n) => e[n]);
        }
        ...
        if (null != t) {
          for (; u.data === lp && 1 === u.children.length; )
            (u = u.children[0]), --i;
          for (let t = h.length - 1; t >= 0 && (f = h[t]).data === lp; --t)
            f.data = null;
        }
        if (
          ((u.parent = fp),
    ...
    (t.thresholdFreedmanDiaconis = function (t, n, e) {
      return Math.ceil(
        (e - n) / (2 * (ut(t, 0.75) - ut(t, 0.25)) * Math.pow(_(t), -1 / 3))
      );
    }),
          ...
          for (var n, e, r, i, o, a = new xp(t, 0), u = [a]; (n = u.pop()); )
            if ((r = n._.children))
              for (
                ...
                u.push((e = n.children[i] = new xp(r[i], i))), (e.parent = n);
      ...
      function T(t, ...n) {
        ...
        function h(t) {
          ...
          a.event(t).zoom(
            "mouse",
            o(
              _(a.that.__zoom, (a.mouse[0] = ne(t, i)), a.mouse[1]),
              a.extent,
              f
            )
          );
      ...
      function N(t, ...r) {
        if (this.__zooming) {
          ...
          if (
            ...
            (a.end(),
            2 === a.taps &&
              ((o = ne(o, this)), Math.hypot(n[0] - o[0], n[1] - o[1]) < g))
          ) {
